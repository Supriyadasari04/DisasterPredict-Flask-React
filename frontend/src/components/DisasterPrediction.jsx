// frontend/src/components/DisasterPrediction.jsx
...
function DisasterPrediction() {
  ...
  // Example mappings (you can expand these as needed)
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <select value={magScale} onChange={(e) => setMagScale(e.target.value)}>
        ...
        <button type="submit">Predict Disaster</button>
      </form>
      ...
      {prediction && (
        <div>
          ...
          <p>
            Predicted Disaster: {prediction.predicted_disaster_name} ({prediction.predicted_label})
          </p>
        </div>
      )}
    </div>
